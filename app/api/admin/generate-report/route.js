...
async function classifyQuestionsAnglesCompetitors(keyword, subredditBlocks, competitors) {
  const promptLines = [];
  promptLines.push(
...
async function writeStrategyNarrative(keyword, rankedSubreddits, competitors) {
